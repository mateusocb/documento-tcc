...
foi descrito a parte de empacotamento do projeto. A
\hyperref[sec:testemirobot]{quarta seção} finaliza o capítulo com exemplos de
código e testes da implementação. O código do projeto que foi desenvolvida pode
ser encontrado em:
